...
const Privacy = () => {
  return (
    <div className="privacy-container">
      ...
      <h2>7. Contact Us</h2>
      <p>For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at info@emallworld.com or by mail using the details provided below:</p>
      <p>E-Mall World, [Your Address Here]</p>
    </div>
  );
};
